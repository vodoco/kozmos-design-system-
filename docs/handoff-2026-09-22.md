# Session handoff — every edge in its role, the five open, the five decisions, PR #56's CI, and the icon tints the live file lost (2026-09-22)

For the next chat. Everything below is on disk, in git or in the live Figma file; nothing depends
on this conversation. It supersedes `docs/handoff-2026-09-21.md`, which stays the
...
> `Co-Authored-By: the coding agent <noreply@anthropic.com>`); ask before a push to a new branch
...
are the site session's (`7dec6c0`, `3bedd72`, `d83feb4`). Each ruling is recorded whole in `docs/handoff-2026-09-21.md`
...
(`docs/handoff-2026-09-19.md`); MAP-595 is parked and complete; a note for Pointr:
...
- `docs/handoff-2026-09-22.md` — this one.
- `docs/handoff-2026-09-21.md` — the 20th and 21st: the parts' parameters, the QA app,
...
- `docs/handoff-2026-09-19.md` — items F, G and Pass 4.
