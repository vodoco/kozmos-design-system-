...
| `map-mode-toggle-gaps-2026-09-15.md` | The SDK's tracking and step-free map toggles measured against Kozmos, the `emphasis`/`labelPlacement` axes and reveal hook they produced, and the inert opacity modifiers they exposed. The second component of the §11 loop. |
