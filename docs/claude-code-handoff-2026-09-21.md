...
| Branch                 | `claude/pointr-browse-repairs`, pushed to `origin`, **nothing merged**. the audit's commit after `8c50b97` is the last change commit (the Figma drift, the evening of the 21st; `git log --oneline -3` names it); every commit after it is documentation only, so the log after it lists docs alone                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
