...
| AI search                       | 48 circle whose conic-gradient ring is a 2.5 band around a 43 white disc, 16 icon; the gradient spins, 3.6 s a turn (the "66 outer" first read here was wrong: re-measured by DOM and pixels on the 21st) | **absent** — no gradient-ring icon button                                                           |
