...
| ⑤ Layer sections section | `77:144`                                                                        | renders faint — Olcay's own section opacity, set on purpose (out of scope); a replacement section was built and reverted the same minute with zero drift; the name now ends "· dimmed on purpose — out of scope for this phase" | leave it dimmed                              |
