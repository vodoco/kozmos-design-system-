...
| Figma            | `Kozmos DS - Core Library` `Yj4O8p6Y9h2Sa9zJVoAiVY`, Components page `4:4`, Product / SDK section `1340:6764`; **94 of 94 sets** on one plugin build (last measured 2026-09-12, `pnpm figma:verify`); the stamp reads behind the plugin by one resumability change that touched no painter                                                                                                                                                        |
