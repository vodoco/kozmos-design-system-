...
import { DesignConfigProvider, Button, useDesignConfig } from '@kozmos/react';
import { GlassSettingsPanel } from '../../../packages/react/src/components/GlassSettingsPanel/GlassSettingsPanel';
    ...
    return (
        <div className="p-8 space-y-12 min-h-[800px] w-full bg-background text-foreground transition-all duration-300 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="glass glass-bevel glass-spotlight glass-edge-spotlight p-10 rounded-2xl flex flex-col justify-between h-80 relative group">
                        <div className="space-y-4">
                            <h3 className="text-3xl font-bold tracking-tighter">Liquid Glass</h3>
                            <p className="opacity-80 text-lg leading-relaxed">
                                Experience true refraction and dispersion. The background blurs and warps behind this card.
                            </p>
                        ...
                        <div className="flex justify-between items-center">
                            <Button variant="glass" size="lg">Explore</Button>
                    ...
                    <div className="space-y-8">
                        <div className="glass glass-bevel glass-spotlight p-8 rounded-xl flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p className="opacity-70 text-sm">Compare this side-by-side with the premium liquid effect.</p>
                            </div>
                            <Button variant="outline" className="ml-auto">Action</Button>
                        </div>

                        <div className="grid grid-cols-2 gap-4">
                            <div className="glass p-6 rounded-lg text-center space-y-2">
                                <div className="text-4xl font-bold">98%</div>
                                <div className="text-xs uppercase tracking-widest opacity-60">Clarity</div>
                            </div>
                            <div className="glass p-6 rounded-lg text-center space-y-2">
                                <div className="text-4xl font-bold"><span className="text-primary">&lt;</span>0.1s</div>
                                <div className="text-xs uppercase tracking-widest opacity-60">Latency</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="space-y-4 relative z-10">
                ...
                <div className="flex flex-wrap gap-4 items-center p-8 border border-white/10 rounded-xl bg-black/5" style={{ backdropFilter: 'none' }}>
