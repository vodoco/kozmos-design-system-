        ...
        HStack(spacing: KozmosDimensions.primitivesLayoutSpacing0) {
            ForEach(0..<steps.count, id: \.self) { index in
                VStack(spacing: KozmosDimensions.primitivesLayoutSpacing50) {
                    ...
                    // a centred 2 on every step until 2026-09-22.
                    ZStack {
                        Circle()
                            .strokeBorder(index <= currentStep ? KozmosColors.primitivesColorsTheme500 : KozmosColors.primitivesColorsForeground500, lineWidth: index <= currentStep ? 2 : 1)
                ...
                if index < steps.count - 1 {
                    Rectangle()
                        .fill(index < currentStep ? KozmosColors.primitivesColorsTheme500 : KozmosColors.semanticsBorderSubtle)
                        .frame(height: 1)
