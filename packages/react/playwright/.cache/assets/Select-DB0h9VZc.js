...
import { u as useComposedRefs, r as reactDomExports } from './index-1HB4mRKF.js';
import { c as createContextScope, u as useControllableState, P as Primitive, a as composeEventHandlers, b as useLayoutEffect2, d as createSlot } from './index-D2TCI6MA.js';
...
import { h as hideOthers, u as useFocusGuards, R as ReactRemoveScroll, F as FocusScope } from './index-D-NL0Tv3.js';
...
import { u as usePrevious } from './index-DoavgIUF.js';
import { V as VISUALLY_HIDDEN_STYLES } from './index-DRLe9xo8.js';
import { d as ChevronDown, w as ChevronUp, c as Check } from './lucide-react-Pfj_YwyJ.js';
...
const Select = ({ onValueChange, ...props }) => {
  const { trackEvent } = useKozmosAnalytics();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Root2,
    {
      onValueChange: (value) => {
        trackEvent("Select", "select_value_changed", { value });
        onValueChange?.(value);
      },
      ...props
    }
...
const SelectTrigger = reactExports.forwardRef(({ className, children, error, wrapperClassName, ...props }, ref) => {
  const errorId = reactExports.useId();
  const hasError = !!error;
  const isStringError = typeof error === "string";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FieldWrapper, { error, errorId, className: wrapperClassName, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Trigger,
    {
      ref,
      "aria-invalid": hasError,
      "aria-describedby": hasError && isStringError ? errorId : void 0,
      className: cn(
...
const SelectContent = reactExports.forwardRef(({ className, children, position = "popper", ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(Portal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Content2,
  {
    ref,
    className: cn(
      "relative z-50 max-h-96 min-w-32 overflow-hidden rounded-[length:var(--primitives-radius-md)] border bg-popover text-popover-foreground shadow-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
...
export { Select as S, SelectContent as a, SelectGroup as b, clamp as c, SelectItem as d, SelectLabel as e, SelectScrollDownButton as f, SelectScrollUpButton as g, SelectSeparator as h, SelectTrigger as i, SelectValue as j };
//# sourceMappingURL=Select-DB0h9VZc.js.map
