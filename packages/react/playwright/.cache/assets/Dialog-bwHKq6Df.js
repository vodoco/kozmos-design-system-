...
import { C as Close, P as Portal, T as Trigger, R as Root, O as Overlay, a as Content, b as Title, D as Description } from './index-C8hDwo1Z.js';
...
const DialogContent = reactExports.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogPortal, { children: [
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Content,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Close, { className: "absolute right-4 top-4 rounded-sm opacity-75 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground", children: [
...
//# sourceMappingURL=Dialog-bwHKq6Df.js.map
