    ...
    theme: {
        extend: {
            colors: {
                ...
                ring: 'var(--primitives-colors-theme-500)',
            },
            borderRadius: {
            ...
            fontFamily: {
                sans: ['var(--primitives-typography-font-family-primary)', 'sans-serif'],
        ...
        plugin(function ({ addUtilities, theme }) {
            addUtilities({
                ...
                '.glass-spotlight::after': {
                    ...
                    'position': 'absolute',
                    'inset': '0',
                    'background': 'radial-gradient(800px circle at var(--spotlight-x) var(--spotlight-y), rgba(255, 255, 255, 0.06), transparent 40%)',
                    'z-index': '10',
                    'pointer-events': 'none',
                },
                '.glass-bevel': {
                ...
                '.glass-edge-spotlight::after': {
                    ...
                    'mask-image': 'radial-gradient(200px circle at var(--spotlight-x) var(--spotlight-y), black, transparent)',
                    '-webkit-mask-image': 'radial-gradient(200px circle at var(--spotlight-x) var(--spotlight-y), black, transparent)',
                    'opacity': '1',
                }
            })
        })
