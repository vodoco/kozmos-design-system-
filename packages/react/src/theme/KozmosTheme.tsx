...
import { DesignConfigProvider, useDesignConfig, DesignConfig } from '../context/DesignConfigContext';
 ...
 */
export const KozmosTheme: React.FC<KozmosThemeProps> = ({ children, config, tokens }) => {
    return (
