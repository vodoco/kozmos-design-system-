...
export const Default: Story = {
    ...
    render: () => {
        ...
        return (
            <WayfindingCard onClose={() => alert('Close Event')} className="w-[360px]">
                <WayfindingInputRow 
                    originValue={origin}
    ...
    render: () => {
        ...
        return (
            <div className="relative w-full min-w-[320px] md:min-w-[800px] h-[500px] bg-slate-100 rounded-xl overflow-hidden border">
                <span className="absolute inset-0 flex items-center justify-center text-muted-foreground font-mono">Simulated Wayfinding Environment</span>
                <MapOverlay position="top-left">
                    <WayfindingCard onClose={() => alert('Close Event')} className="w-full">
                        <WayfindingInputRow 
                            originValue={origin}
                            onOriginChange={setOrigin}
                            destinationValue={dest}
