      ...
      >
        ...
        {panel && (
          <aside
            ...
            className={cn(
              "absolute inset-x-0 bottom-0 z-40 max-h-[min(64dvh,42rem)] overflow-hidden rounded-t-[var(--primitives-radius-lg)] bg-background shadow-2xl md:inset-y-[max(1rem,env(safe-area-inset-top))] md:max-h-none md:w-[min(26rem,42vw)] md:rounded-[var(--primitives-radius-lg)]",
              panelPlacement === "end"
