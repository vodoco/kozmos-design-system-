  ...
  (
    ...
    return (
      <div className="fixed top-4 left-1/2 -translate-x-1/2 z-[100]" ref={ref}>
        {/* The island is black in both themes, as the device's is, so it and
            what sits in it take the dark theme: a nested provider, as SwiftUI
            scopes its island to the dark scheme and Compose to the dark
            palette. It was bg-foreground until 2026-09-22, which turned
            light in dark mode. */}
        <ThemeProvider theme="dark">
          <motion.div
            ...
            className={cn(
              "bg-background text-foreground overflow-hidden shadow-overlay relative max-w-[calc(100vw-32px)]",
              className,
            )}
            {...props}
          >
