    ...
    return (
      ...
      >
        <span className="relative flex items-center justify-center">
          ...
          {featured && (
            <span className="absolute -right-1 -top-1 flex h-4 w-4 items-center justify-center rounded-full bg-background text-primary shadow-sm ring-1 ring-border">
        ...
        {externalLabel && (
          <span
            aria-hidden="true"
            className={cn(
              "absolute max-w-48 whitespace-nowrap rounded-md bg-background px-2 py-1 text-xs font-medium text-foreground shadow-md ring-1 ring-border",
