...
import { Check, ChevronDown, ChevronUp } from "@kozmos-ds/icons";
      ...
      >
        <SelectPrimitive.Trigger
          ...
          className={cn(
            ...
            hasError &&
              "border-destructive text-destructive-text focus:ring-destructive",
            className,
          )}
          {...props}
        >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-marker py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className,
    )}
    {...props}
  >
