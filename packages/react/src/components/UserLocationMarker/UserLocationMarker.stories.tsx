...
const DynamicCompass = () => {
   ...
   return (
       <div className="w-[300px] h-[300px] bg-muted/30 border rounded-lg flex items-center justify-center relative overflow-hidden">
           {/* Grid background simulation */}
           <div className="absolute inset-0" style={{ backgroundImage: 'radial-gradient(var(--primitives-colors-background-200) 1px, transparent 1px)', backgroundSize: '20px 20px' }} />
