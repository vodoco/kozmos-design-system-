...
const blockE = {
  ...
  Select:
    "  props: { disabled: figma.boolean('Disabled'), error: figma.boolean('Error') } /* Connect to SelectTrigger */",
  Checkbox:
  ...
  Drawer:
    "  props: { side: figma.enum('Side') } /* Connect to DrawerContent */",
  ...
  Slider:
    "  props: { disabled: figma.boolean('Disabled'), min: figma.number('Min'), max: figma.number('Max') }",
};
 ...
 */
figma.connect(${cmp}, "https://figma.com/design/Yj4O8p6Y9h2Sa9zJVoAiVY?node-id=TBD", {
${propString},
