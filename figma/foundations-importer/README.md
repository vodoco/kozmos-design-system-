...
Select **Container / v1** and click **Build** after Stack. It creates centered and fluid page-container examples with editable `Container Text`; responsive breakpoints and max-width behavior remain runtime CSS concerns.
